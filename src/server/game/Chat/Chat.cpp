...
bool ChatHandler::HasLowerSecurityAccount(WorldSession* target, uint32 target_account, bool strong)
{
	...
	//this if statement needs to check CONFIG_GM_LOWER_SECURITY otherwise the setting is worthless 
    if ( (sWorld->getBoolConfig(CONFIG_GM_LOWER_SECURITY) && m_session->GetSecurity() < target_ac_sec) || (strong && m_session->GetSecurity() <= target_ac_sec))
	{
